...
namespace ShadowAPI.Migrations
{
    ...
    [Migration("20170904152215_RunnerSkillManyToMany")]
    partial class RunnerSkillManyToMany
    {
            ...
            modelBuilder.Entity("ShadowAPI.Models.SkillSpecialization", b =>
                {
                    ...
                    b.Property<long?>("RunnerSkillRunnerID");

                    b.Property<long?>("RunnerSkillSkillID");
                    ...
                    b.HasIndex("RunnerSkillRunnerID", "RunnerSkillSkillID");
            ...
            modelBuilder.Entity("ShadowAPI.Models.SkillSpecialization", b =>
                {
                    ...
                    b.HasOne("ShadowAPI.Models.RunnerSkill")
                        .WithMany("Specialization")
                        .HasForeignKey("RunnerSkillRunnerID", "RunnerSkillSkillID");
                });
